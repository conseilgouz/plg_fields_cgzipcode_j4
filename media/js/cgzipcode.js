...
var timeout,callDelay=500,
	city,insee,cglong,cglat,cglibs,cgzip,cgzipfid,
	...
	timeout=setTimeout(function(){
        ...
        // Request not finished
			...
			if (xhr.status === 200) {
				...
				if (r.nhits != 1) {
					result.innerHTML = "Vous avez "+r.nhits+" resultat(s). veuillez préciser votre demande."
					city.value = "";city.innerHTML = "";
					insee.value = "";insee.innerHTML = "";
					insee.value = ""; insee.innerHTML ="" ;
					cglong.value = ""; cglong.innerHTML = "";
